...
const PlayerDetailModal: React.FC<PlayerDetailModalProps> = ({ player, onClose }) => {
  ...
  return (
    ...
    >
      <div 
        className="bg-gray-900 rounded-xl shadow-2xl p-6 w-full max-w-2xl border border-gray-700 m-4"
      ...
      >
        ...
        <div>
          <h3 className="text-lg font-semibold mt-6 mb-2">Histórico de Partidas (clique para detalhar)</h3>
